...
@AndroidEntryPoint
class BostonYConnectorDetailsActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Teeba3Theme {
                BostonYConnectorDetailsScreen(intent.getStringExtra("deviceName") ?: "Unknown")
            }
        }
    }
}
...
@Composable
fun BostonYConnectorDetailsScreen(deviceName: String) {
