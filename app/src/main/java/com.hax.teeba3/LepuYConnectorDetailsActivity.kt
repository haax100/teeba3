...
@AndroidEntryPoint
class LepuYConnectorDetailsActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Teeba3Theme {
                LepuYConnectorDetailsScreen(intent.getStringExtra("deviceName") ?: "Unknown")
            }
        }
    }
}
...
@Composable
fun LepuYConnectorDetailsScreen(deviceName: String) {
